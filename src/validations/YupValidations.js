...
export const addProjectSchema = Yup.object({
  ...
  tagcolor1: Yup.string().required('Tag(1) Color is Required'),
  tagname2: Yup.string().required('Tag(2) Name is Required'),
  tagcolor2: Yup.string().required('Tag(2) Color is Required'),
  tagname3: Yup.string().required('Tag(3) Name is Required'),
  tagcolor3: Yup.string().required('Tag(3) Color is Required'),
